...
import { AlertCircle, ArrowRight, Lock, Mail, Phone, Sparkles, Loader2, Sun, Moon, PhoneCall, Eye, EyeOff } from "lucide-react";
            ...
            <div>
              ...
              <div className="relative">
                ...
                <button
                  ...
                  className="absolute right-3.5 top-1/2 -translate-y-1/2 text-slate-400 hover:text-slate-600 dark:text-slate-500 dark:hover:text-slate-300 transition-colors p-1 rounded-lg focus:outline-none"
